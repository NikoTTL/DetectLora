...
%feature("docstring") gr::lora::lora_detect "<+description of block+>"

%feature("docstring") gr::lora::lora_detect::make "Return a shared_ptr to a new instance of lora::lora_detect.

To avoid accidental use of raw pointers, lora::lora_detect's constructor is in a private implementation class. lora::lora_detect::make is the public interface for creating new instances.
