...
_lora_swig.DEMOD_HISTORY_DEPTH_swigconstant(_lora_swig)
DEMOD_HISTORY_DEPTH = _lora_swig.DEMOD_HISTORY_DEPTH

_lora_swig.REQUIRED_PREAMBLE_CHIRPS_swigconstant(_lora_swig)
REQUIRED_PREAMBLE_CHIRPS = _lora_swig.REQUIRED_PREAMBLE_CHIRPS

_lora_swig.REQUIRED_SFD_CHIRPS_swigconstant(_lora_swig)
REQUIRED_SFD_CHIRPS = _lora_swig.REQUIRED_SFD_CHIRPS

_lora_swig.LORA_SFD_TOLERANCE_swigconstant(_lora_swig)
LORA_SFD_TOLERANCE = _lora_swig.LORA_SFD_TOLERANCE

_lora_swig.LORA_PREAMBLE_TOLERANCE_swigconstant(_lora_swig)
LORA_PREAMBLE_TOLERANCE = _lora_swig.LORA_PREAMBLE_TOLERANCE

_lora_swig.DEMOD_SYNC_RECOVERY_COUNT_swigconstant(_lora_swig)
DEMOD_SYNC_RECOVERY_COUNT = _lora_swig.DEMOD_SYNC_RECOVERY_COUNT

_lora_swig.S_RESET_swigconstant(_lora_swig)
S_RESET = _lora_swig.S_RESET

_lora_swig.S_PREFILL_swigconstant(_lora_swig)
S_PREFILL = _lora_swig.S_PREFILL

_lora_swig.S_DETECT_PREAMBLE_swigconstant(_lora_swig)
S_DETECT_PREAMBLE = _lora_swig.S_DETECT_PREAMBLE

_lora_swig.S_SFD_SYNC_swigconstant(_lora_swig)
S_SFD_SYNC = _lora_swig.S_SFD_SYNC

_lora_swig.S_READ_HEADER_swigconstant(_lora_swig)
S_READ_HEADER = _lora_swig.S_READ_HEADER

_lora_swig.S_READ_PAYLOAD_swigconstant(_lora_swig)
S_READ_PAYLOAD = _lora_swig.S_READ_PAYLOAD

_lora_swig.S_OUT_swigconstant(_lora_swig)
...
_lora_swig.SYMBOL_TIMEOUT_COUNT_swigconstant(_lora_swig)
...
class lora_detect(object):
    ...
    def make(spreading_factor, low_data_rate, beta, fft_factor):
        """
        make(unsigned short spreading_factor, bool low_data_rate, float beta, unsigned short fft_factor) -> lora_detect_sptr
        ...
        Params: (spreading_factor, low_data_rate, beta, fft_factor)
        """
        return _lora_swig.lora_detect_make(spreading_factor, low_data_rate, beta, fft_factor)

    make = staticmethod(make)
    __swig_destroy__ = _lora_swig.delete_lora_detect
    __del__ = lambda self: None
lora_detect_swigregister = _lora_swig.lora_detect_swigregister
lora_detect_swigregister(lora_detect)

def lora_detect_make(spreading_factor, low_data_rate, beta, fft_factor):
    """
...
class lora_detect_sptr(object):
    """Proxy of C++ boost::shared_ptr<(gr::lora::lora_detect)> class."""
    ...
    def __init__(self, *args):
        """
        __init__(boost::shared_ptr<(gr::lora::lora_detect)> self) -> lora_detect_sptr
        __init__(boost::shared_ptr<(gr::lora::lora_detect)> self, lora_detect p) -> lora_detect_sptr
        """
        this = _lora_swig.new_lora_detect_sptr(*args)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    def __deref__(self):
        """__deref__(lora_detect_sptr self) -> lora_detect"""
        return _lora_swig.lora_detect_sptr___deref__(self)

    __swig_destroy__ = _lora_swig.delete_lora_detect_sptr
    __del__ = lambda self: None

    def make(self, spreading_factor, low_data_rate, beta, fft_factor):
        """
        make(lora_detect_sptr self, unsigned short spreading_factor, bool low_data_rate, float beta, unsigned short fft_factor) -> lora_detect_sptr
        ...
        Params: (spreading_factor, low_data_rate, beta, fft_factor)
        """
        return _lora_swig.lora_detect_sptr_make(self, spreading_factor, low_data_rate, beta, fft_factor)


    def history(self):
        """history(lora_detect_sptr self) -> unsigned int"""
        return _lora_swig.lora_detect_sptr_history(self)


    def declare_sample_delay(self, *args):
        """
        declare_sample_delay(lora_detect_sptr self, int which, int delay)
        declare_sample_delay(lora_detect_sptr self, unsigned int delay)
        """
        return _lora_swig.lora_detect_sptr_declare_sample_delay(self, *args)


    def sample_delay(self, which):
        """sample_delay(lora_detect_sptr self, int which) -> unsigned int"""
        return _lora_swig.lora_detect_sptr_sample_delay(self, which)


    def output_multiple(self):
        """output_multiple(lora_detect_sptr self) -> int"""
        return _lora_swig.lora_detect_sptr_output_multiple(self)


    def relative_rate(self):
        """relative_rate(lora_detect_sptr self) -> double"""
        return _lora_swig.lora_detect_sptr_relative_rate(self)


    def start(self):
        """start(lora_detect_sptr self) -> bool"""
        return _lora_swig.lora_detect_sptr_start(self)


    def stop(self):
        """stop(lora_detect_sptr self) -> bool"""
        return _lora_swig.lora_detect_sptr_stop(self)


    def nitems_read(self, which_input):
        """nitems_read(lora_detect_sptr self, unsigned int which_input) -> uint64_t"""
        return _lora_swig.lora_detect_sptr_nitems_read(self, which_input)


    def nitems_written(self, which_output):
        """nitems_written(lora_detect_sptr self, unsigned int which_output) -> uint64_t"""
        return _lora_swig.lora_detect_sptr_nitems_written(self, which_output)


    def max_noutput_items(self):
        """max_noutput_items(lora_detect_sptr self) -> int"""
        return _lora_swig.lora_detect_sptr_max_noutput_items(self)


    def set_max_noutput_items(self, m):
        """set_max_noutput_items(lora_detect_sptr self, int m)"""
        return _lora_swig.lora_detect_sptr_set_max_noutput_items(self, m)


    def unset_max_noutput_items(self):
        """unset_max_noutput_items(lora_detect_sptr self)"""
        return _lora_swig.lora_detect_sptr_unset_max_noutput_items(self)


    def is_set_max_noutput_items(self):
        """is_set_max_noutput_items(lora_detect_sptr self) -> bool"""
        return _lora_swig.lora_detect_sptr_is_set_max_noutput_items(self)


    def set_min_noutput_items(self, m):
        """set_min_noutput_items(lora_detect_sptr self, int m)"""
        return _lora_swig.lora_detect_sptr_set_min_noutput_items(self, m)


    def min_noutput_items(self):
        """min_noutput_items(lora_detect_sptr self) -> int"""
        return _lora_swig.lora_detect_sptr_min_noutput_items(self)


    def max_output_buffer(self, i):
        """max_output_buffer(lora_detect_sptr self, int i) -> long"""
        return _lora_swig.lora_detect_sptr_max_output_buffer(self, i)


    def set_max_output_buffer(self, *args):
        """
        set_max_output_buffer(lora_detect_sptr self, long max_output_buffer)
        set_max_output_buffer(lora_detect_sptr self, int port, long max_output_buffer)
        """
        return _lora_swig.lora_detect_sptr_set_max_output_buffer(self, *args)


    def min_output_buffer(self, i):
        """min_output_buffer(lora_detect_sptr self, int i) -> long"""
        return _lora_swig.lora_detect_sptr_min_output_buffer(self, i)


    def set_min_output_buffer(self, *args):
        """
        set_min_output_buffer(lora_detect_sptr self, long min_output_buffer)
        set_min_output_buffer(lora_detect_sptr self, int port, long min_output_buffer)
        """
        return _lora_swig.lora_detect_sptr_set_min_output_buffer(self, *args)


    def pc_noutput_items(self):
        """pc_noutput_items(lora_detect_sptr self) -> float"""
        return _lora_swig.lora_detect_sptr_pc_noutput_items(self)


    def pc_noutput_items_avg(self):
        """pc_noutput_items_avg(lora_detect_sptr self) -> float"""
        return _lora_swig.lora_detect_sptr_pc_noutput_items_avg(self)


    def pc_noutput_items_var(self):
        """pc_noutput_items_var(lora_detect_sptr self) -> float"""
        return _lora_swig.lora_detect_sptr_pc_noutput_items_var(self)


    def pc_nproduced(self):
        """pc_nproduced(lora_detect_sptr self) -> float"""
        return _lora_swig.lora_detect_sptr_pc_nproduced(self)


    def pc_nproduced_avg(self):
        """pc_nproduced_avg(lora_detect_sptr self) -> float"""
        return _lora_swig.lora_detect_sptr_pc_nproduced_avg(self)


    def pc_nproduced_var(self):
        """pc_nproduced_var(lora_detect_sptr self) -> float"""
        return _lora_swig.lora_detect_sptr_pc_nproduced_var(self)


    def pc_input_buffers_full(self, *args):
        """
        pc_input_buffers_full(lora_detect_sptr self, int which) -> float
        pc_input_buffers_full(lora_detect_sptr self) -> pmt_vector_float
        """
        return _lora_swig.lora_detect_sptr_pc_input_buffers_full(self, *args)


    def pc_input_buffers_full_avg(self, *args):
        """
        pc_input_buffers_full_avg(lora_detect_sptr self, int which) -> float
        pc_input_buffers_full_avg(lora_detect_sptr self) -> pmt_vector_float
        """
        return _lora_swig.lora_detect_sptr_pc_input_buffers_full_avg(self, *args)


    def pc_input_buffers_full_var(self, *args):
        """
        pc_input_buffers_full_var(lora_detect_sptr self, int which) -> float
        pc_input_buffers_full_var(lora_detect_sptr self) -> pmt_vector_float
        """
        return _lora_swig.lora_detect_sptr_pc_input_buffers_full_var(self, *args)


    def pc_output_buffers_full(self, *args):
        """
        pc_output_buffers_full(lora_detect_sptr self, int which) -> float
        pc_output_buffers_full(lora_detect_sptr self) -> pmt_vector_float
        """
        return _lora_swig.lora_detect_sptr_pc_output_buffers_full(self, *args)


    def pc_output_buffers_full_avg(self, *args):
        """
        pc_output_buffers_full_avg(lora_detect_sptr self, int which) -> float
        pc_output_buffers_full_avg(lora_detect_sptr self) -> pmt_vector_float
        """
        return _lora_swig.lora_detect_sptr_pc_output_buffers_full_avg(self, *args)


    def pc_output_buffers_full_var(self, *args):
        """
        pc_output_buffers_full_var(lora_detect_sptr self, int which) -> float
        pc_output_buffers_full_var(lora_detect_sptr self) -> pmt_vector_float
        """
        return _lora_swig.lora_detect_sptr_pc_output_buffers_full_var(self, *args)


    def pc_work_time(self):
        """pc_work_time(lora_detect_sptr self) -> float"""
        return _lora_swig.lora_detect_sptr_pc_work_time(self)


    def pc_work_time_avg(self):
        """pc_work_time_avg(lora_detect_sptr self) -> float"""
        return _lora_swig.lora_detect_sptr_pc_work_time_avg(self)


    def pc_work_time_var(self):
        """pc_work_time_var(lora_detect_sptr self) -> float"""
        return _lora_swig.lora_detect_sptr_pc_work_time_var(self)


    def pc_work_time_total(self):
        """pc_work_time_total(lora_detect_sptr self) -> float"""
        return _lora_swig.lora_detect_sptr_pc_work_time_total(self)


    def pc_throughput_avg(self):
        """pc_throughput_avg(lora_detect_sptr self) -> float"""
        return _lora_swig.lora_detect_sptr_pc_throughput_avg(self)


    def set_processor_affinity(self, mask):
        """set_processor_affinity(lora_detect_sptr self, std::vector< int,std::allocator< int > > const & mask)"""
        return _lora_swig.lora_detect_sptr_set_processor_affinity(self, mask)


    def unset_processor_affinity(self):
        """unset_processor_affinity(lora_detect_sptr self)"""
        return _lora_swig.lora_detect_sptr_unset_processor_affinity(self)


    def processor_affinity(self):
        """processor_affinity(lora_detect_sptr self) -> std::vector< int,std::allocator< int > >"""
        return _lora_swig.lora_detect_sptr_processor_affinity(self)


    def active_thread_priority(self):
        """active_thread_priority(lora_detect_sptr self) -> int"""
        return _lora_swig.lora_detect_sptr_active_thread_priority(self)


    def thread_priority(self):
        """thread_priority(lora_detect_sptr self) -> int"""
        return _lora_swig.lora_detect_sptr_thread_priority(self)


    def set_thread_priority(self, priority):
        """set_thread_priority(lora_detect_sptr self, int priority) -> int"""
        return _lora_swig.lora_detect_sptr_set_thread_priority(self, priority)


    def name(self):
        """name(lora_detect_sptr self) -> std::string"""
        return _lora_swig.lora_detect_sptr_name(self)


    def symbol_name(self):
        """symbol_name(lora_detect_sptr self) -> std::string"""
        return _lora_swig.lora_detect_sptr_symbol_name(self)


    def input_signature(self):
        """input_signature(lora_detect_sptr self) -> io_signature_sptr"""
        return _lora_swig.lora_detect_sptr_input_signature(self)


    def output_signature(self):
        """output_signature(lora_detect_sptr self) -> io_signature_sptr"""
        return _lora_swig.lora_detect_sptr_output_signature(self)


    def unique_id(self):
        """unique_id(lora_detect_sptr self) -> long"""
        return _lora_swig.lora_detect_sptr_unique_id(self)


    def to_basic_block(self):
        """to_basic_block(lora_detect_sptr self) -> basic_block_sptr"""
        return _lora_swig.lora_detect_sptr_to_basic_block(self)


    def check_topology(self, ninputs, noutputs):
        """check_topology(lora_detect_sptr self, int ninputs, int noutputs) -> bool"""
        return _lora_swig.lora_detect_sptr_check_topology(self, ninputs, noutputs)


    def alias(self):
        """alias(lora_detect_sptr self) -> std::string"""
        return _lora_swig.lora_detect_sptr_alias(self)


    def set_block_alias(self, name):
        """set_block_alias(lora_detect_sptr self, std::string name)"""
        return _lora_swig.lora_detect_sptr_set_block_alias(self, name)


    def _post(self, which_port, msg):
        """_post(lora_detect_sptr self, swig_int_ptr which_port, swig_int_ptr msg)"""
        return _lora_swig.lora_detect_sptr__post(self, which_port, msg)


    def message_ports_in(self):
        """message_ports_in(lora_detect_sptr self) -> swig_int_ptr"""
        return _lora_swig.lora_detect_sptr_message_ports_in(self)


    def message_ports_out(self):
        """message_ports_out(lora_detect_sptr self) -> swig_int_ptr"""
        return _lora_swig.lora_detect_sptr_message_ports_out(self)


    def message_subscribers(self, which_port):
        """message_subscribers(lora_detect_sptr self, swig_int_ptr which_port) -> swig_int_ptr"""
        return _lora_swig.lora_detect_sptr_message_subscribers(self, which_port)

lora_detect_sptr_swigregister = _lora_swig.lora_detect_sptr_swigregister
lora_detect_sptr_swigregister(lora_detect_sptr)


lora_detect_sptr.__repr__ = lambda self: "<gr_block %s (%d)>" % (self.name(), self.unique_id())
lora_detect = lora_detect.make;
